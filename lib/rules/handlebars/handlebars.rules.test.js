...
describe('Syntax: Handlebars', () => {
  describe('handlebarsParser()', () => {
    it('not match anything that is not handlebars syntax', () => {
    ...
    it('find multiple matches with content between', () => {
      const testCase = '<p>Hello { firstName } from the house of { lastname }</p>';
      const expected = '111000000111111111111100000000000000000001111111111110000';
    ...
    it('match nested, complex expressions', () => {
    ...
    it('match nested expressions at the start of a string', () => {
      const testCase = '{{foobar} {foobar} example} hello world';
      const expected = '111111111111111111111111111000000000000';
      const formatString = Array(testCase.length + 1).join('0');
